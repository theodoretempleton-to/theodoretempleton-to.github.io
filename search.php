<?php get_header(); ?>
	...
	<?php else : ?>
		...
		<p style="text-align: center">Sorry, but you are looking for something that isn't here.  Perhaps you should try another search or go back <a href="<?php echo get_option('home'); ?>/">home</a>?</p>
</div>
